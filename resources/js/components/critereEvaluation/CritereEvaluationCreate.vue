<template>
    <titre-application big-title="CREATION ELEMENT D'APPRECICATION CRITère" small-title="Formulaire" name-page="Element appréciation"></titre-application>
            ...
            <div class="container offset-2 col-md-8">
                ...
                <form method="POST" @submit.prevent="stroreRessource">
                    <div class="mb-4">
                        ...
                        <select v-model="form.categorieEmploye" name="" class="rounded-md form-control">
                            <option value="" readonly>Sélectionnez la catégorie de l'employé</option>
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="form.categorieCritere" name="" class="rounded-md form-control">
                            <option value="" readonly>Sélectionnez la catégorie</option>
                            <option v-for="critere in categorieCriteres" :key="critere.id" :value="critere.id">
                                {{critere.libelle}}
                            </option>
                        </select>
                    </div>
...
<script>
    ...
    export default {
        ...
        setup(){
            ...
            const {tabError,createCritereEvaluation} = useCritereEvaluation();
            ...
            const stroreRessource = async () =>{
                ...
                await createCritereEvaluation({...form})
                form.code = '';
            }
