<template>
    <titre-application big-title="MODIFICATION CAMPAGNE PERFORMANCE" small-title="Formulaire" name-page="Campagne-performance"></titre-application>
            ...
            <div class="container offset-2 col-md-8">
                ...
                <form method="POST" @submit.prevent="editResource">
                    ...
                    <div class=" mb-4">
                        ...
                        <select v-model="campagne.typeevaluation" name="" id="" class="rounded-md form-control form-select">
...
<script>
    ...
    export default {
        ...
        setup(props) {
            const {tabError,campagne,getCampagne,updateCampagne} = useCampagnePerformance();
            onMounted(() => getCampagne(props.id))

            const {annees,typeevaluations,getTypeEvaluations,getAnnes} = useCampagneObjectif();
            onMounted(getAnnes);
