<template>
    <div>
        <div class="flex flex-col">
            <titre-application big-title="LISTE POLES" small-title="Poles" name-page="Liste"></titre-application>
            ...
            <div>
                <div class="mb-2">
                    <div class="row">
                        <div class="mt-1 col-md-2">
                            <router-link :to="{name:'departements.create'}"
                ...
                <div class="py-1">
                    ...
                    <div v-else-if="departements.length>0" class="shadow2">
                        <table class="min-w-full leading-normal table table-bordered table-striped"
                            ...
                            <tbody>
                            <template v-for="departement in departements" :key="departement.id">
                                <tr>
                                    <td class="px-5 py-1 border-b border-gray-200 bg-white text-md"
                                        v-text="departement.code"></td>
                                    <td class="px-5 py-1 border-b border-gray-200 bg-white text-md"
                                        v-text="departement.libelle"></td>
                                    <td class="px-5 py-1 border-b border-gray-200 bg-white text-md"
                                        v-text="departement.direction.libelle"></td>
                                    <td class="px-3 py-1 border-b border-gray-200 bg-white text-sm">
                                        <router-link :to="{ name: 'departements.edit', params: { id: departement.id } }"
                                                     class="btn-green text-decoration-none px-3 py-2 text-white"><i
                                            class="fa fa-edit"></i></router-link>
                                        &nbsp;&nbsp;<button @click="getIdRessource(departement.id)"
...
<script>
    ...
    export default {
        ...
        setup() {
            const {loadRessource,departements, deleteDepartement, getDepartements} = useDepartement();
            ...
            const trashRessource = (id) => {
                ...
                deleteDepartement(id, 'btn-fermer')
            }
