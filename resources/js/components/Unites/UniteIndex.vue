<template>
    <div>
        <div class="flex flex-col">
            <titre-application big-title="LISTE UNITES" small-title="Unités" name-page="Liste"></titre-application>
            ...
            <div>
                <div class="mb-2">
                    <div class="row">
                        <div class="mt-1 col-md-2">
                            <router-link :to="{name:'unites.create'}"
                        ...
                        <div class="col-md-6">
                            <input  v-model="req" @keyup="search" type="text" class="form-control"
                                   placeholder="Rechercher une unité par son code ou libelle">
                ...
                <div class="py-1">
                    ...
                    <div v-else-if="unites.data.length>0" class="shadow2">
                        ...
                        <table class="min-w-full leading-normal table table-bordered table-striped"
                            ...
                            <tbody>
                            <template v-for="unite in unites.data" :key="unite.id">
                                <tr>
                                    <td class="px-5 py-1 border-b border-gray-200 bg-white text-md"
                                        v-text="unite.code"></td>
                                    <td class="px-5 py-1 border-b border-gray-200 bg-white text-md"
                                        v-text="unite.libelle"></td>
                                    <td class="px-5 py-1 border-b border-gray-200 bg-white text-md"
                                        v-text="unite.service.libelle"></td>
                                    <td class="px-3 py-1 border-b border-gray-200 bg-white text-sm">
                                        <router-link :to="{ name: 'unites.edit', params: { id: unite.id } }"
                                                     class="btn-green text-decoration-none px-3 py-2 text-white"><i
                                            class="fa fa-edit"></i></router-link>
                                        &nbsp;&nbsp;<button @click="getIdRessource(unite.id)"
...
<script>
    ...
    export default {
        ...
        setup() {
            const req = ref('');
            const {loadRessource,unites,countData,countPage,getUniteByIdService,getRessources,searchRessource,paginateData, getUnites, deleteUnite} = useUnite();
            ...
            const onchangeService = () => {
                ...
                getUniteByIdService(idService,true);
            }
