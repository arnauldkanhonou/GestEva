<template>
    <div class="flex flex-col">
        <titre-application big-title="LISTE PERFORMANCES EVALUATIONS" small-title="Performances-Evaluations"
        ...
        <div>
            <div class="mb-2">
                <div class="row">
                    <div class="mt-1 col-md-2">
                        <router-link :to="{name:'niveau.performances.create'}"
            ...
            <div class="py-1">
                ...
                <div v-else-if="niveauPerformances.length>0" class="shadow2">
...
<script>
    ...
    export default {
        ...
        setup() {
            const {loadRessource, niveauPerformances, deleteNiveauPerformance, getNiveauPerformances} = useNiveauPerformance();
            ...
            const trashRessource = (id) => {
                ...
                deleteNiveauPerformance(id, 'btn-fermer')
            }


            onMounted(getNiveauPerformances);
