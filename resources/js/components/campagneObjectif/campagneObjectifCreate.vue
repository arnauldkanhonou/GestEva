<template>
    <titre-application big-title="CREATION CAMPAGNE OGBJECTIF" small-title="Formulaire" name-page="Campagne-objectif"></titre-application>
                ...
                <form method="POST" @submit.prevent="storeRessource">
                    <div class="mb-4">
                        ...
                        <input :class="Errors.libelle?'is-invalid':''" @keyup="validateInputlibelle"
                               ...
                               id="libelle" placeholder="Saisir intiutlé de la campagne"
                    ...
                    <div class="mb-4">
                        <label for="annee" class="mb-1 block text-base font-medium text-[#07074D]">
                            <b>Les objectifs de quelle année veut-on ajuster?<i class="text-red-600">*</i></b>
                        </label>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const {tabError,annees,getAnnes,createCampagne} = useCampagneObjectif();
            onMounted(getAnnes);
