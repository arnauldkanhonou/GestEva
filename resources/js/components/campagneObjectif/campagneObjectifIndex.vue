<template>
    <div>
        <div class="flex flex-col">
            <titre-application big-title="LISTE CAMPAGNE OBJECTIF" small-title="Campagne-objectif"
                ...
                <div class="mb-2">
                    <div class="row">
                        <div class="mt-1 col-md-2">
                            <router-link :to="{name:'campagne.objectif.create'}"
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control"
                                   placeholder="Rechercher une campagne par son libelle">
                        </div>
                    </div>
                </div>
                <div class="py-1">
                                ...
                                <tr>
                                   ...
                                   <span class="px-2  font-semibold rounded-full"
                                    ...
                                    <td class="px-3 py-1 border-b border-gray-200 bg-white text-sm">
                                        <router-link :to="{ name: 'campagne.objectif.edit', params: { id: campagne.id } }"
...
<script>
    ...
    export default {
        ...
        setup() {
            const {loadRessource,campagnes, getCampagnes, deleteCampagne} = useCampagneObjectif();
