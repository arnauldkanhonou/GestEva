<template>
    <div class="flex flex-col">
        <titre-application big-title="LISTE TYPE EVALUATIONS" small-title="Type-evaluations"
        ...
        <div>
            <div class="mb-2">
                <div class="row">
                    <div class="mt-1 col-md-2">
                        <router-link :to="{name:'typeevaluations.create'}"
            ...
            <div class="py-1">
                ...
                <div v-else-if="typeEvaluations.length>0" class="shadow2">
                    ...
                    <table class="min-w-full leading-normal table table-bordered table-striped"
                        ...
                        <tbody>
                        <template v-for="typeEvaluation in typeEvaluations" :key="typeEvaluation.id">
                            <tr>
                                <td v-if="typeEvaluation.code=='EA'" class="px-5 py-1 border-b border-gray-200 bg-white text-md">EEAN</td>
                                <td v-else class="px-5 py-1 border-b border-gray-200 bg-white text-md">EEMP</td>
                                <td class="px-5 py-1 border-b border-gray-200 bg-white text-md"
                                    v-text="typeEvaluation.libelle"></td>
                                <td class="px-3 py-1 border-b border-gray-200 bg-white text-sm">
                                    <router-link
                                        :to="{ name: 'typeevaluations.edit', params: { id: typeEvaluation.id } }"
                                        class="btn-green text-decoration-none px-3 py-2 text-white"><i
                                        class="fa fa-edit"></i></router-link>
                                    &nbsp;&nbsp;<button @click="getIdRessource  (typeEvaluation.id)"
...
<script>
    ...
    export default {
        ...
        setup() {
            const {loadRessource,typeEvaluations, deleteTypeEvaluation, getTypeEvaluations} = useTypeEvaluation();
            ...
            const trashRessource = (id) => {
                ...
                deleteTypeEvaluation(id, 'btn-fermer')
            }
