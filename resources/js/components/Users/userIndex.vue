<template>
    <div>
        <div class="flex flex-col">
            <titre-application big-title="LISTE COMPTES UTILISATEUR" small-title="Comptes" name-page="Liste"></titre-application>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control"
                                   placeholder="Rechercher un compte par le code employé">
                        </div>
                    </div>
                </div>
                <div class="py-1">
                    <div v-if="users.length===0" class="col-md-2 offset-5 mt-4">
                    ...
                    <div v-else class="shadow  overflow-hidden">
                                ...
                                <tr>
                                    ...
                                    <td class="px-1 py-1 border-b border-gray-200 bg-white text-sm">
                                        <template v-for="role in user.roles" :key="role.id">
                                            <span class="badge bg-primary" ><b>{{role.name}}</b></span>&nbsp;
                                        </template>
                                    ...
                                    <td class="px-3 py-1 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        &nbsp;&nbsp;<button @click="getIdRessource(user.id)"
...
<script>
    ...
    export default {
        ...
        setup() {
            const {users, getUsers, deleteUser,getDate} = useUsers();
