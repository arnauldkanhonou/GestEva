<template>
    <titre-application big-title="CREATION Critère-evaluation" small-title="Formulaire" name-page="Critère-evaluation"></titre-application>
...
<script>
    ...
    export default {
        ...
        setup(){
            ...
            const {tabError,createCategorieCritere} = useCategorieCritere();
            ...
            const stroreRessource = async () =>{
                ...
                await createCategorieCritere({...form})
                form.code = '';
            }
