<template>
    <div class="flex flex-col">
        <titre-application big-title="LISTE Critère-evaluation" small-title="Critère-evaluation"
            ...
            <div class="mb-2">
                <div class="row">
                    <div class="mt-1 col-md-2">
                        <router-link :to="{name:'categories.cirtere.create'}"
                    ...
                    <div class="col-md-6">
                        <input v-model="req" @keyup="search" type="text" class="form-control"
                               placeholder="Rechercher un critère par son libellé ou code">
                    </div>
                </div>
            ...
            <div class="py-1">
                ...
                <div v-else-if="countData.length>0" class="shadow2">
                    <table class="min-w-full leading-normal table table-bordered table-striped"
                        ...
                        <tbody>
                        <template v-for="categorie in categorieCriteres.data" :key="categorie.id">
                            <tr>
                                ...
                                <td class="px-3 py-1 border-b border-gray-200 bg-white text-sm">
                                    <router-link :to="{ name: 'categories.cirtere.edit', params: { id: categorie.id } }"
...
<script>
    ...
    export default {
        ...
        setup() {
            const req = ref('');
            const {loadRessource, categorieCriteres,countPage,countData,getRessources,searchRessource,paginateData, deleteCategorieCritere, getCategorieCriteres} = useCategorieCritere();
            ...
            const trashRessource = (id) => {
                ...
                deleteCategorieCritere(id, 'btn-fermer')
            }
