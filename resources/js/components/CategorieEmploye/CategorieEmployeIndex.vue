<template>
    <div class="flex flex-col">
        <titre-application big-title="LISTE GROUPE professionnel" small-title="Formulaire"
            ...
            <div class="mb-2">
                <div class="row">
                    <div class="mt-1 col-md-2">
                        <router-link :to="{name:'categorie.employe.create'}"
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control"
                               placeholder="Rechercher une categorie code">
                    </div>
                </div>
            </div>
            <div class="py-1">
                ...
                <div v-else-if="categorieEmployes.length>0" class="shadow2">
                    <table class="min-w-full leading-normal table table-bordered table-striped"
                        ...
                        <tbody>
                        <template v-for="categorie in categorieEmployes" :key="categorie.id">
                            <tr>
                                <td class="px-5 py-1 border-b border-gray-200 bg-white text-md">
                                    <b v-if="categorie.code==='AC'">C</b> <b v-else-if="categorie.code==='AM'">M</b> <b v-else>E</b>
                                </td>
                                <td class="px-5 py-1 border-b border-gray-200 bg-white text-md" v-text="categorie.libelle"></td>
                                <td class="px-3 py-1 border-b border-gray-200 bg-white text-sm">
                                    <router-link :to="{ name: 'categorie.employe.edit', params: { id: categorie.id } }"
...
<script>
    ...
    export default {
        ...
        setup() {
            const {loadRessource,categorieEmployes, deleteCategorieEmploye, getCategorieEmployes} = useCategorieEmploye();
            ...
            const trashRessource = (id) => {
                ...
                deleteCategorieEmploye(id, 'btn-fermer')
            }
