<template>
    <div>
        <div class=" flex flex-col">
            <titre-application big-title="ENTRETIEN INDIVIDUEL PAR RUBRIQUE" small-title="Entretien"
                ...
                <div class="col-md-12">
                    ...
                    <div v-if="load">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h6><b>PERFORMANCE REALISEE:</b> &nbsp;&nbsp;&nbsp; <b class="text-red-600" v-text="form.pointGblobal"></b>
                                </h6>
                            </div>
                        </div>
                        <hr>
...
-->
                        ...
                        <section v-if="form.tabBesoinFormation.length>0">
                            <h5 class="uppercase">Développement de compétences</h5>
                            <br>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <template v-else>
                                <tr>
                                    <td colspan="5" class="py-2 border-b border-gray-200 bg-white text-md">
                                        AUCUNE EVALUATION TROUVEE POUR LE SERVICE CHOISI
                                    </td>
                                </tr>
                    ...
                    .then((response)=>{
                        if(response.data.data.code===500){
                            ...
                            if(evaluations.value.length===0){
                                ...
                                Swal.fire({
                                    title: 'Erreur',
                                    text: 'Aucune évaluations non validée disponible pour les collaborateurs du service choisi',
                                    icon: 'error',
                                });
                            }
                            form.startEva = false;
                ...
                axios.post("validation/performance", form)
                    .then((response) => {
                        if (response.data.data.code === 500) {
                            ...
                            form.pointGblobal = response.data.data.evaluation.performanceRealiser+form.sommeBonus;
