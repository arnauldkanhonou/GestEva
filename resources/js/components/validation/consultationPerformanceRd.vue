                            ...
                            <tr>
                                ...
                                <td class="py-2 border-b border-gray-200 bg-white text-md">
                                    ...
                                    <button v-if="typeEvaluation.code==='EMP'" @click="showEvaluationMipacours(salarie.idEval)" type="button" title="Consulter L'evaluation"
                                            class="btn-sm bg-green-600 text-white px-2 py-1 rounded"
                                            data-bs-toggle="modal" data-bs-target="#staticBackdropEMP">
                                        <i class="fa fa-eye-slash"></i>
                                    </button>&nbsp;&nbsp;
                                    <button v-if="typeEvaluation.code!=='EMP'" @click="validationUnitaire(salarie.idEval,false)" type="button" title="Valider L'évaluation"
...
<!--                    </div>-->
                    <div class="offset-1 col-md-10">
                        ...
                        <button :disabled="evaluations.length===0 || typeEvaluation.code==='EMP'" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                                class="btn btn-danger">VALIDER TOUTES
                            LES EVALUATIONS
                        </button>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered relative w-auto pointer-events-none">
                <div
                    ...
                    <div style="background-color: #acb3c4"
                        ...
                        <h5 class="text-red-600 font-medium leading-normal text-gray-800" id="exampleModalL">
                        ...
                        <div v-else>
                            ...
                            <table class="table table-striped">
                                ...
                                <tr class="hauteurTr" style="border: black 1px solid">
                                    <td style="border: black 1px solid" class="hauteur" align="right" colspan="3">
                                        <b>Total</b></td>
                                    <td style="border: black 1px solid" class="hauteur" align="right"><b>0</b></td>
                                </tr>
                            </table>
                            <hr>
                            <br>
                            ...
                            <table class="table table-striped">
                                ...
                                <tr style="border: black 1px solid">
                                    ...
                                    <td style="border: black 1px solid" class="hauteur" align="right"><b class="text-red-600">0</b></td>
                                </tr>
                                <tr style="border: black 1px solid">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr v-for="objectif in form1.nouvelleObjectifs" style="border: black 1px solid">
                                    <td style="border: black 1px solid" class="hauteur">{{objectif.libelle}}</td>
                                    <td style="border: black 1px solid" class="hauteur">{{objectif.actionCle}}
                                    </td>
                                    <td style="border: black 1px solid" class="hauteur">
...
<!--                        </button>-->
        ...
        <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
             id="staticBackdropEMP" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
             aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered relative w-auto pointer-events-none">
                <div
                    class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-clip-padding rounded-md outline-none text-current">
...
<script>
    ...
    export default {
        ...
        setup(){
            ...
            const {typeEvaluation,typeEvaluations,getTypeEvaluation,getTypeEvaluations} = useTypeEvaluation();
            onMounted(getAnnes);
            ...
            const validationPerformance = async () => {
                ...
                await axios.post('validation/performance/service/' + form.service + '/' + form.annee, {...data})
                    .then((response) => {
                        if (response.data.data.code === 500) {
                            Swal.fire({
