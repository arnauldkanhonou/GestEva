<template>
    <div>
        <div class=" flex flex-col">
            <titre-application big-title="ENTRETIEN-PAR RUBRIQUE" small-title="Entretien"
            ...
            <div class="mt-3 row">
                <div class="col-md-4">
                    ...
                    <select  @change="getEvaluationSalarie()" v-model="form.collaborateur" name="" id=""
                ...
                <div class="col-md-4">
                    ...
                    <select  @change="getEvaluationSalarie()" v-model="form.annee" name=""
                            class="rounded-md form-control">
                ...
                <div class="col-md-4">
                    ...
                    <select v-model="form.rubrique" @change="getEvaluationSalarie()" name="" id="rubriq"
                            class="rounded-md form-control">
                ...
                <!-- <div class="col-md-4">
                     <label class="mb-1 block text-base font-medium text-[#07074D]">
                         <b>Catégorie critère<i class="text-red-600">*</i></b>
                     </label>
                     <select v-model="form.cateCritere" name="" id="catCrit" class="rounded-md form-control">
                         <option value="" readonly>Sélectionnez une catégorie de critère</option>
                         <option v-for="categorieCritere in categorieCriteres" :value="categorieCritere.id" :key="categorieCritere.id">
                             {{categorieCritere.libelle}}
                         </option>
                     </select>
                 </div>-->
            </div>
    ...
    export default {
        ...
        setup() {
            ...
            const checkRadioButtonNiveau = (idObjectif, idNiveau) => {
                ...
                axios.post('add/niveau/objectif/collaborateur/' + user.id + '/' + form.evaluation.id+'/param', {...data})
                    .then((response) => {
                        if (response.data.data.code === 500) {
                            Swal.fire({
                                title: 'Erreur serveur',
            ...
            const checkRadioButtonPonderationCritere = (idCritere, idPonderation, codeCategorie) => {
                ...
                axios.post('add/critere/evaluer/' + user.id + '/' + form.evaluation.id+'/param', {...data})
                    .then((response) => {
            ...
            const deleteObjectif = (libelle, index) => {
                ...
                if (trouver) {
                    ...
                    axios.post('destroy/objectif/by/libelle/' + user.id + '/' + form.evaluation.id+'/param', {...data})
                        .then((response) => {
                            if (response.data.data.code === 500) {
                                Swal.fire({
                                    title: 'Erreur serveur',
            ...
            const setBesoinFormation = async () => {
                ...
                if (!erreur) {
                    ...
                    await axios.post('add/besoin/formation/collaborateur/' + user.id + '/' + form.evaluation.id+'/param', {...data})
                        .then((response) => {
            ...
            const deleteBesoinFormation = (libelle, index) => {
                ...
                if (trouver) {
                    ...
                    axios.post('destroy/besoin/formation/by/libelle/' + user.id + '/' + form.evaluation.id+'/param', {...data})
                        .then((response) => {
            ...
            const setCommentaireEvaluation = async (type) => {
                ...
                await axios.post('add/commentaire/evaluation/collaborateur/' + user.id + '/' + form.evaluation.id+'/param', {...data})
                    .then((response) => {
                        if (response.data.data.code===500){
                            Swal.fire({
                                title: 'Erreur serveur',
