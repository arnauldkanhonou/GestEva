<template>
    <div>
        <titre-application big-title="EVALUATION MI-PARCOURS" small-title="evaluation"
                           name-page="mi-parcours"></titre-application>
        <div v-if="load" class="mt-4">
                    ...
                    <template v-for="(objectif,index) in objectifs" :key="objectif.id">
                        <tr>
                            ...
                            <td style="width: 5%" class=" py-1 border-b border-gray-200 bg-white text-sm">
                                &nbsp;&nbsp;<button title="Ajouter un commentaire sur cet objectif" @click="setCommentaireObjectif(objectif.id,objectif.commentaireEvaluerMP,false)"
            ...
            <div class="mt-5">
                <button id="btnRealisation" data-bs-toggle="modal" data-bs-target="#staticBackdrop1"
                    ...
                    class="fa fa-plus-circle"></i>AUTRES REALISATIONS OU DIFFICULTES
                </button>
            </div>
            <table class="mt-4 min-w-full leading-normal table table-bordered table-striped"
                   style="background-color:#acb3c4 ">
                ...
                <div
                    ...
                    <div style="background-color: #acb3c4"
                        ...
                        <h5 class="text-red-600 font-medium leading-normal text-gray-800" id="exampleModalLabel1">
                            <b><i class="fa fa-plus-circle"></i>AJOUTER UNE REALISATION OU UNE DIFFICULTE</b>
                        </h5>
                    </div>
                    <div class="modal-body">
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            onMounted(() => {
                axios.get('init/evaluation/miparcours/' + user.id+'/param')
                    .then((response) => {
            ...
            onMounted(() => getObjectifCollaborateurValider());
